...
|------------|----------|-------------|-------------------|----------|---------------|
| 1,000      | 500      | 10,955      | **10.96**         | 0        | 0             |
| 50,000     | 500      | 665,257     | **13.31**         | 0        | 0             |
| 1,000,000  | 500      | 12,851,729  | **12.85**         | 0        | 0             |

## Go Stdlib `hash/fnv`

| **Keys**   | **Runs** | **ns/op**   | **ns/op per key** | **B/op** | **Allocs/op** |
|------------|----------|-------------|-------------------|----------|---------------|
| 1,000      | 500      | 26,189      | **26.19**         | 0        | 0             |
| 50,000     | 500      | 1,379,844   | **27.60**         | 0        | 0             |
| 1,000,000  | 500      | 28,578,066  | **28.58**         | 0        | 0             |
...
|---------------------|--------:|------------:|------------:|------------------:|--------:|-------------:|
| Insert No Resize    |     500 |   1,000,000 | 118,728,860 |            118.73 |   79,865 | 3,999 |

### Custom hash table

| **Benchmark**       | **Runs** | **Elements** |   **ns/op**  | **ns/op per key** | **B/op** | **Allocs/op** |
|---------------------|--------:|------------:|------------:|------------------:|--------:|-------------:|
| Insert No Resize    |     500 |   1,000,000 | 142,202,195 |            142.20 |   79,859 | 3,999 |
...
| **Benchmark**         | **Runs** | **Elements** |   **ns/op**  | **ns/op per key** | **B/op**     | **Allocs/op** |
|-----------------------|--------:|------------:|------------:|------------------:|-------------:|-------------:|
| Insert With Resize    |     500 |   1,000,000 | 276,326,278 |            276.33 | 104,666,475  | 11,664 |

### Custom hash table

| **Benchmark**         | **Runs** | **Elements** |   **ns/op**  | **ns/op per key** | **B/op**     | **Allocs/op** |
|-----------------------|--------:|------------:|------------:|------------------:|-------------:|-------------:|
| Insert With Resize    |     500 |   1,000,000 | 326,393,858 |            326.39 | 204,576,758  | 4,002 |
...
|-------------------------|--------:|---------:|--------:|-------------:|
| Delete existing key     |     500 | 47,849   | 15,853  | 799 |

### Custom hash table

| **Benchmark**           | **Runs** | **ns/op** | **B/op** | **Allocs/op** |
|-------------------------|--------:|---------:|--------:|-------------:|
| Delete existing key     |     500 | 47,985   | 15,854  | 799 |
...
| **Benchmark**          | **Runs** | **ns/op** | **B/op** | **Allocs/op** |
|------------------------|--------:|---------:|--------:|-------------:|
| Search existing key    |     500 |    15.80 |       0 |            0 |

### Custom hash table

| **Benchmark**          | **Runs** | **ns/op** | **B/op** | **Allocs/op** |
|------------------------|--------:|---------:|--------:|-------------:|
| Search existing key    |     500 |    42.40 |       0 |            0 |
...
| **Benchmark**             | **Runs** | **ns/op** | **B/op** | **Allocs/op** |
|---------------------------|--------:|---------:|--------:|-------------:|
| Search non-existing key   |     500 |    11.40 |       0 |            0 |

### Custom hash table

| **Benchmark**             | **Runs** | **ns/op** | **B/op** | **Allocs/op** |
|---------------------------|--------:|---------:|--------:|-------------:|
| Search non-existing key   |     500 |    64.40 |      16 |            1 |


## Probing-heavy search (collision stress)

### Go map

| **Benchmark**                         | **Runs** | **ns/op** | **B/op** | **Allocs/op** |
|---------------------------------------|--------:|---------:|--------:|-------------:|
| Probing heavy collision search        |     500 |    11.00 |       0 |            0 |

### Custom hash table

| **Benchmark**                         | **Runs** | **ns/op** | **B/op** | **Allocs/op** |
|---------------------------------------|--------:|---------:|--------:|-------------:|
| Probing heavy collision search        |     500 |    46.60 |       0 |            0 |
